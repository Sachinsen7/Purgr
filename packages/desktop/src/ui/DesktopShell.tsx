  ...
  return (
    <div class="min-h-screen bg-[#111319] text-[#e2e2eb]">
      <aside class="fixed inset-y-0 left-0 hidden w-64 border-r border-white/5 bg-[#111319] px-4 py-6 lg:flex lg:flex-col">
        <div class="px-2">
          <h1 class="font-headline text-xl font-extrabold tracking-tight text-white">DevSweep</h1>
          ...
          {props.sidebarContent ?? (
            <>
              <div class="mb-4 flex items-center gap-3">
                ...
                <div>
                  <p class="text-xs font-bold text-white">Alex Dev</p>
              ...
              <div class="rounded-xl bg-[#191b22] p-3">
                ...
                <p class="mt-2 text-sm font-semibold text-white">Pro Workspace</p>
                <p class="mt-1 text-xs text-[#bacac5]/65">Cloud cleanup disabled, Ollama local.</p>
              </div>
            </>
          )}
        </div>
      ...
      <div class="lg:pl-64">
        ...
        <main class="min-h-[calc(100vh-4rem)] px-6 py-8 lg:px-8">{props.children}</main>
      </div>
    </div>
  );
}
