...
export default function Dashboard() {
  ...
  const pendingReview = () =>
    currentScan()?.results.filter((result) => result.recommendation === "review").length ?? 0;
    ...
    >
      <div class="space-y-8">
        <div class="grid gap-6 xl:grid-cols-[1.6fr_1fr]">
          <section class="relative overflow-hidden rounded-[28px] border border-white/5 bg-[#1e1f26] p-8">
            <div class="absolute -right-20 -top-20 h-72 w-72 rounded-full bg-[#57f1db]/10 blur-[110px]" />
            ...
            <div class="relative">
              ...
              <h2 class="mt-3 font-headline text-5xl font-extrabold tracking-tight text-white md:text-6xl">
                47.3 <span class="text-3xl font-medium text-[#bacac5]">GB</span>
              </h2>
              <p class="mt-4 max-w-xl text-sm leading-6 text-[#bacac5]">
                Total developer artifacts detected across caches, extensions, SDKs, and inactive
                project directories. The current scan flow is ready to continue from the desktop shell.
              </p>
              <div class="mt-8 flex flex-wrap gap-3">
                ...
                <button
                  class="rounded-full bg-[#33343b] px-7 py-3 text-sm font-bold text-white transition hover:bg-[#373940]"
          ...
          <section class="rounded-[28px] border border-white/5 bg-[#1e1f26] p-6">
            <p class="font-mono text-[10px] uppercase tracking-[0.24em] text-[#bacac5]/55">
              Category Breakdown
            </p>
            <div class="relative mx-auto mt-8 flex h-40 w-40 items-center justify-center">
              <div class="absolute inset-0 rounded-full border-[14px] border-[#33343b]" />
              <div class="absolute inset-0 rotate-45 rounded-full border-[14px] border-[#57f1db] border-b-transparent border-r-transparent" />
              <div class="absolute inset-0 -rotate-12 rounded-full border-[14px] border-[#9cd1c6] border-l-transparent border-t-transparent" />
              <div class="flex flex-col items-center">
                <span class="font-mono text-xl font-bold text-white">4</span>
                ...
                {(tool) => (
                  <div class="flex items-center justify-between text-xs text-white/90">
                    <span class="flex items-center gap-2">
                      <span class={`h-2 w-2 rounded-full ${tool.color}`} />
                      {tool.label}
                    </span>
                    <span class="font-mono text-[#bacac5]">{tool.share}</span>
                  </div>
                )}
              </For>
            </div>
        ...
        <div class="grid gap-6 md:grid-cols-3">
          <article class="rounded-3xl border border-white/5 bg-[#1e1f26] p-5 transition hover:bg-[#282a30]">
            <div class="mb-4 flex items-start justify-between">
              <div class="rounded-xl bg-[#57f1db]/10 p-2 text-[#57f1db]">
                <span class="material-symbols-outlined">check_circle</span>
              </div>
              <span class="rounded-full bg-[#57f1db]/10 px-2 py-1 font-mono text-[10px] uppercase tracking-[0.2em] text-[#57f1db]">
                Recommended
              </span>
            </div>
            <p class="text-xs text-[#bacac5]/65">Safe to delete</p>
            <p class="mt-1 font-mono text-3xl font-bold text-white">
              12.4 <span class="text-sm font-normal text-[#bacac5]">GB</span>
            </p>
            <div class="mt-4 h-1 overflow-hidden rounded-full bg-[#111319]">
              <div class="h-full w-[40%] bg-[#57f1db]" />
            </div>
          </article>
          ...
          <article class="rounded-3xl border border-white/5 bg-[#1e1f26] p-5 transition hover:bg-[#282a30]">
            ...
            <p class="text-xs text-[#bacac5]/65">Needs manual review</p>
            <p class="mt-1 font-mono text-3xl font-bold text-white">
              {pendingReview()} <span class="text-sm font-normal text-[#bacac5]">items</span>
            </p>
            <div class="mt-4 h-1 overflow-hidden rounded-full bg-[#111319]">
              <div class="h-full w-[60%] bg-[#ffd1aa]" />
            </div>
          </article>
          ...
          <article class="rounded-3xl border border-white/5 bg-[#1e1f26] p-5 transition hover:bg-[#282a30]">
            ...
            <p class="text-xs text-[#bacac5]/65">Total files scanned</p>
            <p class="mt-1 font-mono text-3xl font-bold text-white">
              {totalFiles().toLocaleString()}
            </p>
            <div class="mt-4 h-1 overflow-hidden rounded-full bg-[#111319]">
              <div class="h-full w-[55%] bg-[#ffb4ab]" />
            </div>
          </article>
        </div>
        ...
        <div class="grid gap-6 xl:grid-cols-[1.5fr_1fr]">
          <section class="rounded-[28px] border border-white/5 bg-[#1e1f26] p-6">
            <div class="mb-6 flex items-center justify-between">
              <h3 class="font-headline text-xl font-bold text-white">Recent Activity</h3>
            ...
            <Show
              ...
              fallback={
                <div class="rounded-2xl border border-dashed border-white/10 bg-[#191b22] p-6 text-sm text-[#bacac5]">
                  No completed scan history yet. Start a scan to populate this activity rail.
                </div>
              }
            >
              <div class="space-y-3">
                  ...
                  {(scan) => (
                    ...
                    >
                      <div class="flex items-center gap-4">
                        ...
                        <div>
                          <p class="text-sm font-semibold text-white">{scan.rootPath}</p>
                          <p class="font-mono text-[10px] uppercase tracking-[0.18em] text-[#bacac5]/50">
                            {scan.endTime ? new Date(scan.endTime).toLocaleString() : "In progress"}
                          </p>
                        </div>
                      </div>
          ...
          <div class="space-y-6">
            <section class="rounded-[28px] border border-white/5 bg-[#1e1f26] p-6">
              ...
              <div class="mt-4 flex flex-wrap gap-2">
                <For each={["VS Code", "Android SDK", "Python", "Node.js"]}>
                  {(tool, index) => (
                    <span
            ...
            <section class="rounded-[28px] border border-white/5 bg-gradient-to-br from-[#1e1f26] to-[#191b22] p-6">
              ...
              <div class="mt-4 rounded-2xl border border-[#57f1db]/15 bg-[#111319] p-4">
                <div class="flex items-center gap-3">
                  <span class="material-symbols-outlined text-[#57f1db]">terminal</span>
                  <div class="min-w-0 flex-1">
                    <p class="font-mono text-[10px] uppercase tracking-[0.18em] text-[#bacac5]/45">
                      Last Path Scanned
                    </p>
                    <p class="truncate text-xs text-white/90">
                      {currentScan()?.rootPath ?? "~/dev/projects/web-app/node_modules"}
                    </p>
                  </div>
                </div>
                <button
